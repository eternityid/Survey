...
{
    public class SimpleSurveyDefinitionSample
    {
        private readonly SurveyDesign.SurveyDesign.Factory _surveyDesignFactory;

        public SimpleSurveyDefinitionSample(SurveyDesign.SurveyDesign.Factory surveyDesignFactory)
        {
            ...
            var survey = create.Survey(
                create.Folder("Main Page",
                    create.Page(page =>
                        ...
                        create.SingleSelectionQuestion("SingleSelectionQuestion1", new[] { "Demo Single Selection Question 1", "no::Demo enkeltvalgspørsmål 1" }, new[] { "Please choose your answer", "no::Vennligst velg" }, 
                            q => {
                    ...
                    create.Page(page =>
                        ...
                        create.SingleSelectionQuestion("SingleSelectionQuestion2", "Demo Single Selection Question 2", "Please choose your answer", 
                            q => {
                                q.OrderType = OrderType.InOrder;
                            },
                    ...
                    create.ThankYouPage()));
            survey.SurveySettings.SurveyTitle = "Simple Survey";
