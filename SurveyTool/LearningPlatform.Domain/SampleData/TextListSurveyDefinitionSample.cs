...
{
    public class TextListSurveyDefinitionSample
    {
        private readonly SurveyDesign.SurveyDesign.Factory _surveyDesignFactory;
        public TextListSurveyDefinitionSample(SurveyDesign.SurveyDesign.Factory surveyDesignFactory)
        {
        ...
        public Survey CreateSurvey()
        {
            ...
            var survey = create.Survey(
                create.Folder("Main Page",
                    ...
                    create.ThankYouPage()));
            survey.SurveySettings.SurveyTitle = "Text List Survey";
