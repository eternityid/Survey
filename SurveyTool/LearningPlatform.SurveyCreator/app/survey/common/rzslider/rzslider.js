...
.factory('CustomSlider', ['$timeout', '$document', 'throttle', function ($timeout, $document, throttle) {
    /**
     * Slider
     *
    ...
    Slider.prototype = {
        ...
        init: function () {
            ...
            if (this.scope.rzSliderChange) {
                this.onChangeFn = this.scope.rzSliderChange;
            }
...
.directive('rzslider', ['CustomSlider', function (CustomSlider) {
    return {
        restrict: 'EA',
        scope: {
            rzSliderFloor: '=?',
        ...
        link: function (scope, elem, attr) {
            return new CustomSlider(scope, elem, attr);
        }
    };
}]);
