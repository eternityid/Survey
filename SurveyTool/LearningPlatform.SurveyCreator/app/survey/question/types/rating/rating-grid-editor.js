(function () {
    ...
    angular
        .module('svt')
        .directive('ratingGridEditor', RatingGridEditor);

    function RatingGridEditor() {
        var directive = {
            restrict: 'E',
            scope: {
                question: '='
            },
            templateUrl: 'survey/question/types/rating/rating-grid-editor.html',
            controller: 'ratingGridEditorCtrl',
            controllerAs: 'vm',
            link: link
        };
